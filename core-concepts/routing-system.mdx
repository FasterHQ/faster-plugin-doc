...
Faster CMS uses the PluginRouter from `@tryghost/plugin-sdk` to create routes with built-in authentication, middleware support, and automatic URL prefixing.
